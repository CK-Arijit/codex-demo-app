  ...
  return (
    <section className="space-y-6">
      <header>
        ...
        <p className="mt-2 text-sm text-slate-600">Placeholder page: registration flow will be added later.</p>
      </header>
      ...
      <p className="text-sm text-slate-700">
        Link placeholder: sign in at <code className="rounded bg-aqua-100 px-1 py-0.5">/sign-in</code>
      </p>
    </section>
  );
}
