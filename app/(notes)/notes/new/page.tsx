  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-sm text-slate-600">
        Standalone placeholder for <code className="rounded bg-aqua-100 px-1 py-0.5">/notes/new</code>. No create
        logic or redirect behavior is implemented in this scaffold.
      </p>
